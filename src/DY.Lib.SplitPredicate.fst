...
val mk_global_pred_wrong_label:
  ...
  the_label:func.label_t -> l:list (func.label_t & local_pred func) -> labeled_data:func.labeled_data_t ->
  Lemma
...
val mk_global_pred_correct_aux:
  func:split_predicate_input_values -> gpred:global_pred func -> lpreds1:list (func.label_t & local_pred func) -> lpreds2:list (func.label_t & local_pred func) -> the_label:func.label_t -> lpred:local_pred func ->
  Lemma
  (requires
...
val mk_global_pred_correct:
  func:split_predicate_input_values -> lpreds:list (func.label_t & local_pred func) -> the_label:func.label_t -> lpred:local_pred func ->
  Lemma
  (requires
...
val mk_global_pred_eq:
  ...
  Lemma
  (mk_global_pred func lpreds labeled_data <==> (
...
let rec mk_global_pred_eq func lpreds labeled_data =
  match lpreds with
  | [] -> ()
  | (the_label, lpred)::tpreds ->
    mk_global_pred_eq func tpreds labeled_data;
    match func.decode_labeled_data labeled_data with
    | None -> ()
    | Some (label, raw_data) -> ()
