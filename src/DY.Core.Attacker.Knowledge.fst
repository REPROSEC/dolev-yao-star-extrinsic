...
val corrupted_state_is_publishable:
  ...
  (ensures is_publishable invs.crypto_invs tr content)
let corrupted_state_is_publishable invs tr prin sess_id content =
  state_is_knowable_by invs tr prin sess_id content
...
let rec attacker_only_knows_publishable_values_aux invs step tr msg =
  if step = 0 then (
    FStar.Classical.forall_intro   (FStar.Classical.move_requires   (msg_sent_on_network_are_publishable invs tr));
    FStar.Classical.forall_intro   (FStar.Classical.move_requires   (msg_sent_on_network_are_publishable invs tr));
    FStar.Classical.forall_intro_3 (FStar.Classical.move_requires_3 (corrupted_state_is_publishable invs tr));
    FStar.Classical.forall_intro   (FStar.Classical.move_requires   (literal_to_bytes_is_publishable invs.crypto_invs tr))
  ) else (
    FStar.Classical.forall_intro   (FStar.Classical.move_requires   (attacker_only_knows_publishable_values_aux invs (step-1) tr));
    FStar.Classical.forall_intro_2 (FStar.Classical.move_requires_2 (concat_preserves_publishability invs.crypto_invs tr));
    FStar.Classical.forall_intro_2 (FStar.Classical.move_requires_2 (split_preserves_publishability invs.crypto_invs tr));
    FStar.Classical.forall_intro_4 (                move_requires_4 (aead_enc_preserves_publishability invs.crypto_invs tr));
    FStar.Classical.forall_intro_4 (                move_requires_4 (aead_dec_preserves_publishability invs.crypto_invs tr));
    FStar.Classical.forall_intro   (FStar.Classical.move_requires   (pk_preserves_publishability invs.crypto_invs tr));
    FStar.Classical.forall_intro_3 (FStar.Classical.move_requires_3 (pk_enc_preserves_publishability invs.crypto_invs tr));
    FStar.Classical.forall_intro_2 (FStar.Classical.move_requires_2 (pk_dec_preserves_publishability invs.crypto_invs tr));
    FStar.Classical.forall_intro   (FStar.Classical.move_requires   (vk_preserves_publishability invs.crypto_invs tr));
    FStar.Classical.forall_intro_3 (FStar.Classical.move_requires_3 (sign_preserves_publishability invs.crypto_invs tr));
    FStar.Classical.forall_intro   (FStar.Classical.move_requires   (hash_preserves_publishability invs.crypto_invs tr));
    ()
  )
#pop-options
...
let attacker_only_knows_publishable_values invs tr msg =
  ...
  with _. (
    attacker_only_knows_publishable_values_aux invs step tr msg
  )
