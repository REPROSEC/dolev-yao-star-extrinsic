...
let prepare_msg1 alice bob =
  ...
  let* x = mk_rand (DhKey "DH.dh_key" empty) (principal_tagged_state_label alice alice_si "DH.Session") 32 in
...
let prepare_msg2 alice bob msg_id =
  ...
  let* y = mk_rand (DhKey "DH.dh_key" empty) (principal_tagged_state_label bob bob_si "DH.Session") 32 in
...
let send_msg2 global_sess_id bob bob_si =
  ...
  | ResponderSentMsg2 alice gx gy y -> (
    ...
    let* n_sig = mk_rand SigNonce (principal_tag_label bob "DY.Lib.State.PrivateKeys") 32 in
...
let send_msg3 global_sess_id alice bob alice_si =
  ...
  | InitiatorSendMsg3 bob gx gy x -> (
    ...
    let* n_sig = mk_rand SigNonce (principal_tag_label alice "DY.Lib.State.PrivateKeys") 32 in
