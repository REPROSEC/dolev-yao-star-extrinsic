...
let dh_crypto_preds = {
  ...
  sign_pred = {
    pred = (fun tr vk sig_msg ->
      ...
      (exists prin. get_signkey_label tr vk == long_term_key_label prin /\ (
...
val compute_message2_proof:
  ...
  (requires
    ...
    is_signature_key (SigKey "DH.SigningKey" empty) (long_term_key_label bob) tr sk_b /\
...
val decode_and_verify_message2_proof:
  ...
  (requires
    ...
    is_verification_key (SigKey "DH.SigningKey" empty) (long_term_key_label bob) tr pk_b
  )
  (ensures (
...
val compute_message3_proof:
  ...
  (requires
    ...
    gx = dh_pk x /\
    is_signature_key (SigKey "DH.SigningKey" empty) (long_term_key_label alice) tr sk_a /\
...
val decode_and_verify_message3_proof:
  ...
  (requires
    ...
    is_verification_key (SigKey "DH.SigningKey" empty) (long_term_key_label alice) tr pk_a
  )
  (ensures (
    let gy = dh_pk y in
